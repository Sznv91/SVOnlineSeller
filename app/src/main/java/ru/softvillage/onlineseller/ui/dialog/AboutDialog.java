package ru.softvillage.onlineseller.ui.dialog;
...
public class AboutDialog extends DialogFragment {
    ...
    public void onStart() {
        ...
        if (UiPresenter.getInstance().getCurrentTheme() == UiPresenter.THEME_LIGHT) {
    ...
    private void initContent() {
        switch (dialogType) {
            ...
            case TYPE_RATE_THE_APP:
                ...
                dIcon = ContextCompat.getDrawable(about_dialog_icon.getContext(), R.drawable.ic_icon_menu_icon_rate_the_app);
                break;
    ...
    private void initButton() {
        if (dialogType.equals(TYPE_USER_AGREEMENT)) {
            ...
            about_dialog_checkbox.setOnCheckedChangeListener((buttonView, isChecked) -> {
                if (isChecked) {
                    AppPresenter.getInstance().setCheckedUserAgreement(true);
                    ...
                    AppPresenter.getInstance().setCheckedUserAgreement(false);
                    if (UiPresenter.getInstance().getCurrentTheme() == UiPresenter.THEME_LIGHT)
                        about_dialog_button_close.setTextColor(ContextCompat.getColor(about_dialog_button_close.getContext(), R.color.active_fonts_lt));
                    else
                        about_dialog_button_close.setTextColor(ContextCompat.getColor(about_dialog_button_close.getContext(), R.color.active_fonts_dt));
            ...
            about_dialog_checkbox.setChecked(AppPresenter.getInstance().isCheckedUserAgreement());
        } else {
            about_dialog_button_close.setOnClickListener(v -> dismiss());
        }
    }
